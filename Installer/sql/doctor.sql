...
-- Dumping structure for table doctor.admin
...
-- Dumping data for table doctor.admin: ~0 rows (approximately)
DELETE FROM `admin`;
...
-- Dumping structure for table doctor.affilliated_hospitals
...
-- Dumping data for table doctor.affilliated_hospitals: ~20 rows (approximately)
DELETE FROM `affilliated_hospitals`;
/*!40000 ALTER TABLE `affilliated_hospitals` DISABLE KEYS */;
...
/*!40000 ALTER TABLE `affilliated_hospitals` ENABLE KEYS */;

-- Dumping structure for table doctor.amenities_categories
...
-- Dumping data for table doctor.amenities_categories: ~20 rows (approximately)
DELETE FROM `amenities_categories`;
/*!40000 ALTER TABLE `amenities_categories` DISABLE KEYS */;
INSERT INTO `amenities_categories` (`id`, `facility_name`) VALUES
	...
	(20, 'Notary Public');
/*!40000 ALTER TABLE `amenities_categories` ENABLE KEYS */;
...
-- Dumping data for table doctor.appointment: ~0 rows (approximately)
DELETE FROM `appointment`;
/*!40000 ALTER TABLE `appointment` DISABLE KEYS */;
/*!40000 ALTER TABLE `appointment` ENABLE KEYS */;

-- Dumping structure for table doctor.center_packages
...
-- Dumping data for table doctor.center_packages: ~3 rows (approximately)
DELETE FROM `center_packages`;
/*!40000 ALTER TABLE `center_packages` DISABLE KEYS */;
INSERT INTO `center_packages` (`id`, `package_name`, `package_price`, `package_period`) VALUES
	(1, 'silver', '50', '45 days'),
	(2, 'gold', '100', '4 months'),
	(3, 'diamond', '1000', '1 year');
/*!40000 ALTER TABLE `center_packages` ENABLE KEYS */;

-- Dumping structure for table doctor.cities
...
-- Dumping data for table doctor.cities: 6 rows
DELETE FROM `cities`;
...
-- Dumping structure for table doctor.city_categories
...
-- Dumping data for table doctor.city_categories: ~49 rows (approximately)
DELETE FROM `city_categories`;
/*!40000 ALTER TABLE `city_categories` DISABLE KEYS */;
INSERT INTO `city_categories` (`country_id`, `state_id`, `id`, `city_name`) VALUES
	...
	('40', '48', 58, 'sdvcfdfv'),
	('41', '49', 59, 'sin');
/*!40000 ALTER TABLE `city_categories` ENABLE KEYS */;

-- Dumping structure for table doctor.clinic
...
-- Dumping data for table doctor.clinic: ~7 rows (approximately)
DELETE FROM `clinic`;
...
-- Dumping structure for table doctor.clinic_gallery
...
-- Dumping data for table doctor.clinic_gallery: ~12 rows (approximately)
DELETE FROM `clinic_gallery`;
...
-- Dumping structure for table doctor.countries
...
-- Dumping data for table doctor.countries: 239 rows
...
-- Dumping structure for table doctor.country_categories
...
-- Dumping data for table doctor.country_categories: ~30 rows (approximately)
DELETE FROM `country_categories`;
/*!40000 ALTER TABLE `country_categories` DISABLE KEYS */;
INSERT INTO `country_categories` (`id`, `country_name`) VALUES
	...
	(40, 'ranji'),
	(41, 'poland');
/*!40000 ALTER TABLE `country_categories` ENABLE KEYS */;

-- Dumping structure for table doctor.degree_categories
...
-- Dumping data for table doctor.degree_categories: ~30 rows (approximately)
DELETE FROM `degree_categories`;
/*!40000 ALTER TABLE `degree_categories` DISABLE KEYS */;
INSERT INTO `degree_categories` (`id`, `degree_name`, `description`) VALUES
	...
	(29, 'DS', ''),
	(30, 'DSurg', '');
/*!40000 ALTER TABLE `degree_categories` ENABLE KEYS */;

-- Dumping structure for table doctor.doctor
...
-- Dumping data for table doctor.doctor: ~11 rows (approximately)
DELETE FROM `doctor`;
...
INSERT INTO `doctor` (`end_date`, `trial_date`, `type_selection`, `cities_id`, `clinic_id`, `hospital_id`, `medical_id`, `status`, `terms`, `id`, `email`, `password`, `doctor_firstname`, `doctor_lastname`, `doctor_age`, `display_image`, `specialty`, `doctor_sex`, `doctor_degree`, `doctor_affiliations`, `doctor_languages`, `doctor_experience`, `doctor_awards`, `doctor_memberships`, `visitation`, `insurance`, `about_doctor`, `working_time`, `break_time`, `vacation_time`, `cost_duration`, `time_duration`, `latitude`, `longitude`, `phone`, `doctor_office_country`, `doctor_office_address`, `doctor_office_state`, `doctor_office_city`, `doctor_office_zip`, `username`) VALUES
	...
	(NULL, '2019-03-29', 'individual', 4, NULL, NULL, NULL, '1', 'agreed', 11, 'luisroyrsg@gmail.com', '96e79218965eb72c92a549dd5a330112', 'Yuyuan', 'Zhang', 30, 'assets/uploads/doctor/me.png', NULL, 'Male', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, '{"mon":{"start":"","end":""},"tue":{"start":"","end":""},"wed":{"start":"8:30am","end":"12:00pm"},"thu":{"start":"10:30am","end":"5:30pm"},"fri":{"start":"1:30pm","end":"5:30pm"},"sat":{"start":"","end":""},"sun":{"start":"","end":""}}', '{"mon":[{"start":"","end":""}],"tue":[{"start":"","end":""}],"wed":[{"start":"","end":""}],"thu":[{"start":"12:00pm","end":"1:30pm"}],"fri":[{"start":"2:30pm","end":"4:00pm"}],"sat":[{"start":"","end":""}],"sun":[{"start":"","end":""}]}', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL);
/*!40000 ALTER TABLE `doctor` ENABLE KEYS */;

-- Dumping structure for table doctor.doctor_gallery
...
-- Dumping data for table doctor.doctor_gallery: ~9 rows (approximately)
DELETE FROM `doctor_gallery`;
...
INSERT INTO `doctor_gallery` (`id`, `doctor_id`, `image`, `user_id`) VALUES
	...
	(22, '11', 'assets/uploads/doctor/me.png', NULL);
/*!40000 ALTER TABLE `doctor_gallery` ENABLE KEYS */;

-- Dumping structure for table doctor.doctor_package
...
-- Dumping data for table doctor.doctor_package: ~23 rows (approximately)
DELETE FROM `doctor_package`;
/*!40000 ALTER TABLE `doctor_package` DISABLE KEYS */;
...
/*!40000 ALTER TABLE `doctor_package` ENABLE KEYS */;

-- Dumping structure for table doctor.events
...
-- Dumping data for table doctor.events: ~5 rows (approximately)
DELETE FROM `events`;
...
-- Dumping structure for table doctor.hospital
...
-- Dumping data for table doctor.hospital: ~7 rows (approximately)
...
-- Dumping structure for table doctor.hospital_gallery
...
-- Dumping data for table doctor.hospital_gallery: ~2 rows (approximately)
DELETE FROM `hospital_gallery`;
...
-- Dumping structure for table doctor.hospital_package
...
-- Dumping data for table doctor.hospital_package: ~9 rows (approximately)
DELETE FROM `hospital_package`;
/*!40000 ALTER TABLE `hospital_package` DISABLE KEYS */;
...
/*!40000 ALTER TABLE `hospital_package` ENABLE KEYS */;

-- Dumping structure for table doctor.insurance_categories
...
-- Dumping data for table doctor.insurance_categories: ~18 rows (approximately)
DELETE FROM `insurance_categories`;
...
-- Dumping structure for table doctor.languages
...
-- Dumping data for table doctor.languages: 1 rows
...
-- Dumping structure for table doctor.language_categories
...
-- Dumping data for table doctor.language_categories: ~33 rows (approximately)
...
-- Dumping structure for table doctor.language_set
...
-- Dumping data for table doctor.language_set: ~2 rows (approximately)
DELETE FROM `language_set`;
...
-- Dumping structure for table doctor.medical_center
...
-- Dumping data for table doctor.medical_center: ~5 rows (approximately)
...
-- Dumping structure for table doctor.medical_gallery
...
-- Dumping data for table doctor.medical_gallery: ~3 rows (approximately)
DELETE FROM `medical_gallery`;
/*!40000 ALTER TABLE `medical_gallery` DISABLE KEYS */;
...
/*!40000 ALTER TABLE `medical_gallery` ENABLE KEYS */;

-- Dumping structure for table doctor.packages
...
-- Dumping data for table doctor.packages: ~3 rows (approximately)
...
-- Dumping structure for table doctor.patient
...
-- Dumping data for table doctor.patient: ~1 rows (approximately)
DELETE FROM `patient`;
...
INSERT INTO `patient` (`status`, `id`, `email`, `password`, `patient_firstname`, `patient_lastname`, `terms`, `patient_sex`, `patient_display_image`, `insurance`, `visitation`, `dob`, `age`, `languages`, `marital_status`, `phone`, `address`, `country`, `state`, `city`, `zip`, `username`, `trial_date`, `end_date`) VALUES
	...
	(1, 2, 'luisroyrjh@outlook.com', '96e79218965eb72c92a549dd5a330112', 'luis', 'roy', 'agreed', 'male', NULL, '', '17', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL);
/*!40000 ALTER TABLE `patient` ENABLE KEYS */;

-- Dumping structure for table doctor.rating_clinic
...
-- Dumping data for table doctor.rating_clinic: ~0 rows (approximately)
DELETE FROM `rating_clinic`;
/*!40000 ALTER TABLE `rating_clinic` DISABLE KEYS */;
INSERT INTO `rating_clinic` (`clinic_id`, `patient_id`, `id`, `rating`, `review`, `date`) VALUES
	('1', '1', 1, '4', 'good', '26-09-2016');
/*!40000 ALTER TABLE `rating_clinic` ENABLE KEYS */;

-- Dumping structure for table doctor.rating_doctor
...
-- Dumping data for table doctor.rating_doctor: ~22 rows (approximately)
DELETE FROM `rating_doctor`;
/*!40000 ALTER TABLE `rating_doctor` DISABLE KEYS */;
...
/*!40000 ALTER TABLE `rating_doctor` ENABLE KEYS */;

-- Dumping structure for table doctor.rating_hospital
...
-- Dumping data for table doctor.rating_hospital: ~2 rows (approximately)
DELETE FROM `rating_hospital`;
/*!40000 ALTER TABLE `rating_hospital` DISABLE KEYS */;
...
/*!40000 ALTER TABLE `rating_hospital` ENABLE KEYS */;

-- Dumping structure for table doctor.rating_medical
...
-- Dumping data for table doctor.rating_medical: ~2 rows (approximately)
DELETE FROM `rating_medical`;
/*!40000 ALTER TABLE `rating_medical` DISABLE KEYS */;
...
/*!40000 ALTER TABLE `rating_medical` ENABLE KEYS */;

-- Dumping structure for table doctor.settings
...
-- Dumping data for table doctor.settings: ~0 rows (approximately)
...
INSERT INTO `settings` (`id`, `title`, `logo`, `favicon`, `smtp_username`, `smtp_host`, `smtp_password`, `sender_id`, `sms_username`, `sms_password`, `paypal`, `paypalid`, `admin_email`, `languages`, `currency`, `api_key`, `app_key`) VALUES
	(1, 'Bookmydoc', 'uploads/common/1493899510_logo.png', 'uploads/common/1493899510_fav__icon.png', 'luisroyrsg@gmail.com', 'smtp.gmail.com', 'fiudizshgfauximr', '101', 'manu', '676', 'https://www.sandbox.paypal.com/cgi-bin/webscr', 'shajeermohammed@gmail.com', 'luisroyrsg@gmail.com', '1', 227, 'AIzaSyAPkwBOzGBH1V1sRBzmCWQS-7XoTgPghT0', NULL);
/*!40000 ALTER TABLE `settings` ENABLE KEYS */;

-- Dumping structure for table doctor.specialty_categories
...
-- Dumping data for table doctor.specialty_categories: ~21 rows (approximately)
DELETE FROM `specialty_categories`;
/*!40000 ALTER TABLE `specialty_categories` DISABLE KEYS */;
INSERT INTO `specialty_categories` (`id`, `specialty_name`) VALUES
	...
	(35, 'sdf'),
	(36, 'zsdds');
/*!40000 ALTER TABLE `specialty_categories` ENABLE KEYS */;

-- Dumping structure for table doctor.state_categories
...
-- Dumping data for table doctor.state_categories: ~46 rows (approximately)
DELETE FROM `state_categories`;
/*!40000 ALTER TABLE `state_categories` DISABLE KEYS */;
INSERT INTO `state_categories` (`country_id`, `id`, `state_name`) VALUES
	...
	('40', 48, 'lanj'),
	('41', 49, 'symi');
/*!40000 ALTER TABLE `state_categories` ENABLE KEYS */;

-- Dumping structure for table doctor.visit_categories
...
-- Dumping data for table doctor.visit_categories: ~46 rows (approximately)
DELETE FROM `visit_categories`;
/*!40000 ALTER TABLE `visit_categories` DISABLE KEYS */;
INSERT INTO `visit_categories` (`specialty_id`, `id`, `reason`) VALUES
	...
	('1', 46, 'sdcd'),
	('1', 47, 'sdsammm');
/*!40000 ALTER TABLE `visit_categories` ENABLE KEYS */;

-- Dumping structure for table doctor.web_tokens
...
-- Dumping data for table doctor.web_tokens: ~0 rows (approximately)
